...
var modalidad = url.get('modalidad');
var id_encuesta = url.get('idenc');
...
function guardarDatos(){
    ...
    let url = base_url+"/Home/recRespuestasHeteroevaluacionAlumno?res="+respuestas_preguntas+"&dat="+datos_usuario+"&modalidad="+modalidad+"&id_encuesta="+id_encuesta;
    fetch(url)
            .then(res => res.json())
            .then((out) => {
                console.log(out);
