...
<head>
    ...
    <title>Heteroevaluacion: Alumnos</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content">
                <div class="container" id="container">
                    <div class="col-md-12">
                        <div class="text-center"><h2><b><?php echo($data['materia']['materia']['fullname']) ?></b></h2></div>
                        <div class="text-center col-md-12"><h4><strong>Docente: </strong>  <?php echo($data['materia']['docente'][0]['firstname']." ".$data['materia']['docente'][0]['lastname']) ?></h4></div><br>
