					            ...
					            <form  action="Home/usuario" method="POST" class="col-md-10">
                                    <div class="input-group mb-3"> 
                                        <select class="custom-select" name="plataforma" id="plataforma" required style="border-radius: 10px;"> 
                                            ...
                                            <option value="prepaabierta">Prepatoria Abierta</option>
						            ...
						            <div class="input-group mb-3">
							            ...
							            <input type="text" id="username" name="username" class="form-control input_user" value="" placeholder="Usuario" required>
						            </div>
