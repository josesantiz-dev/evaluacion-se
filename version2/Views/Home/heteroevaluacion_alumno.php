            ...
            <div class="content">
                <div class="container" id="container">
                    <div class="col-md-12">
                        ...
                        <div class="text-center col-md-12"><h4><strong>Docente: </strong>  <?php echo($data['materia']['request'][0]['id_user']." ".$data['materia']['request'][0]['teacher_firstname']." ".$data['materia']['request'][0]['teacher_lastname']) ?></h4></div><br>
